...
import 'package:hijauin_frontend_mobile/features/home/presentation/components/aqi_info_bottom_sheet.dart';

class AqiHomeWidget extends StatelessWidget {
  final String? aqi;
  final String? city;

  const AqiHomeWidget({super.key, this.aqi = "...", this.city = "..."});
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        showAqiInfoBottomSheet(context);
      },
      child: Container(
        height: 180,
